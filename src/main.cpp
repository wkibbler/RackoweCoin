...
#if defined(NDEBUG)
# error "Rackowecoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xb39660fd21b39b430ee68dd288f6fe5df141cea2c1c04397e7b29aa65a34019e");
...
const string strMessageMagic = "Rackowecoin Signed Message:\n";
...
{
    // Rackowecoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Rackowecoin: 3.5 days
static const int64 nTargetSpacing = 2.5 * 60; // Rackowecoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Rackowecoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Rackowecoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Rackowecoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb39660fd21b39b430ee68dd288f6fe5df141cea2c1c04397e7b29aa65a34019e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Miles Manley may have actually made a friend";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 35 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("044d33c443da3dc8ebc65306b131814d7bce1602cae6f34c13a7fd562434f9c64af8a816842be30baf88f8c28e7bf4082cab8ff6cda93e9465d5409ad82f3bcc2f") << OP_CHECKSIG;
        CBlock block;
        ...
        assert(block.hashMerkleRoot == uint256("0x27aa227732258ab59d37a6b0f72f8dbdb81f46dc76fca19662371b273bccf9ff"));
...
unsigned char pchMessageStart[4] = { 0xfd, 0xc3, 0xb9, 0xde }; // Rackowecoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RackowecoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RackowecoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static RackowecoinMiner(CWallet *pwallet)
{
    printf("RackowecoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("rackowecoin-miner");
    ...
    try { loop {
        ...
        printf("Running RackowecoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("RackowecoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&RackowecoinMiner, pwallet));
}
