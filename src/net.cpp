...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Rackowecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"rackowecointools.com", " 206.189.26.208"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Rackowecoin is probably already running."), addrBind.ToString().c_str());
        else
